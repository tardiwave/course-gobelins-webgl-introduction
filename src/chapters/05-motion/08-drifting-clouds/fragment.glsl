...
void main() {
  ...
  // How far the noise pushes the layer; at 0.0 the clouds scroll without swirling.
  float drift = 0.05;

  // Two samples at different places and speeds, so the sheet folds instead of sliding.
